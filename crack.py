...
[  Created By : ./G1AN404-XD ]
[  My Team    : Ratu Error & Muslim Cyber Army ]
[  WhasApp Me : 082217667161 ]
"""
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.facebook.com/profile.php?id=100067602271889')
				bot_komen()
...
def bot_komen():
	...
	reac = ('ANGRY')
	post = ('129960642600678')
	post2 = ('129960642600678')
